...
public class Reservation {
    ...
    @OneToMany(mappedBy = "reservation", fetch = FetchType.LAZY) private Set<ChiTietDichVu> serviceUsages;
    ...
    public Set<ChiTietDichVu> getServiceUsages() { return serviceUsages; }
